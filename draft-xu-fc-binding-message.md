...
Suppose that the simplified RIB table of AS 65536 is as follows. That means there is 1 BGP-UPDATE that is announced from AS 65539 to AS 65537, 1 BGP-UPDATE that is announced from AS 65538 to AS 65537, and 1 BGP-UPDATE that is announced from AS 65537 to AS 65536.
